        ...
        if referral_reward_inr > 0:
            try:
                ...
                referrer_notify_text = (
                    f"🎉 **New Referral!**\n\n"
                    f"User {user.first_name} joined using your referral link.\n"
                    f"💰 **You will get reward** once referred user successfully completed task."
                )
...
@Client.on_message(filters.text & filters.private & ~filters.command(["start", "admin", "check", "addbalance", "removebalance", "addholdbalance", "removeholdbalance", "waittime", "checkholds", "broadcast", "stats", "user", "payout", "commission", "setup", "minimumpayout", "admincommands", "login", "margin", "setmargin", "reset", "getdata", "approveall"]))
